...
public class Menu {
	...
	public static void main(String[] args) {
		 ...
		 * c1.visualizar();
		 * 
		 * //Alteramos o Saldo da Conta c1 c1.setSaldo(35000.00f);
		 * 
		 * //Vizualizamos o Saldo da Conta c1 System.out.println("\\n\\n" +
		 * c1.getSaldo());
		 * 
		 * //Criamos o Objeto conta c2 Conta c2 = new Conta(2, 123, 1, "Dener Cardoso",
		 * 50000.0f); //Vizualizamos o dados da Conta C2 c2.vizualizar();
		 * 
		 * //Efetuamos um Saque na Conta c2 if(c2.sacar(1000.00f))
		 * System.out.println("\n\n" + c2.getSaldo());
		 * 
		 * //Efetuamos um Saque na Conta c1 c1.depositar(10000.0f);
		 * 
		 * //Vizualizamos o Saldo da Conta c1 apos o Deposito c1.visualizar();
		 */

		/*
		 * ContaCorrente c3 = new ContaCorrente(1, 123, 1, "Vitoria", 30000.0f,
		 * 1000.0f);
		 * 
		 * c3.visualizar();
		 * 
